...
Are they "intelligent"? Who cares!
...
1. **Prediction:** estimate or predict a quantity, based on other cheaper or earlier data.
   1. Great for things like predicting prices, fraud detection, building recommender systems, or helping a [missile know where it is](https://www.youtube.com/watch?v=6iBeRfOAAwk).
   ...
   3. Straightforward and effective!
...
If it's so powerful, why shouldn't we jam it in all of our products and ride the hype train to the future?

Let me prepare a short and non-exhaustive list:
...
Unless you are operating at a truly massive scale, or machine learning is your business's key competitive advantage, don't waste your time on this!

## But what *should* I do with machine learning?

With your feet planted firmly in reality, it's time to decide how to actually apply machine learning to your business.
...
1. Have a clear measurement of what a "succesful" business outcome looks like.
