...
* [@cart](https://github.com/sponsors/cart) for creating Bevy, writing the initial change detection implementation (including the awesome `DerefMut` trick) and helping us polish the new implementation
